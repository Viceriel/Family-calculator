...
describe("Compute engine", ()=>
{
   ...
   it("Compute engine should compute", ()=>
   {
       ...
       expect(engine.IntegratedWhealth.data).to.deep.equal([2450, 2900, 3350, 3800, 4250, 4700, 5150, 5600, 6050, 6500, 6950, 7432, 7882, 8332, 8782, 9232, 9682, 10132, 10582, 11032, 11482, 11932, 12382, 13053.92]);
   });
});
